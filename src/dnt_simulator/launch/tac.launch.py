...
def _create_actions(context, *args, **kwargs):
    ...
    print(f"[stonefish] tacc profile={profile} -> rate={cfg['simulation_rate']} res={cfg['window_res_x']}x{cfg['window_res_y']} quality={cfg['rendering_quality']} (auto {detect_profile()})")
    return [
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                "scenario_desc": PathJoinSubstitution([FindPackageShare("dnt_simulator"), "scenarios", "TACC.scn"]),
